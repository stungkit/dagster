// Generated GraphQL builders, do not edit manually.
...
type AddDynamicPartitionResult =
...
type AlertFailureEvent = MessageEvent &
  RunEvent & {
...
type AlertStartEvent = MessageEvent &
  RunEvent & {
...
type AlertSuccessEvent = MessageEvent &
  RunEvent & {
...
type AssetAssetMaterializationsArgs = {
  afterTimestampMillis?: InputMaybe<Scalars['String']['input']>;
  beforeTimestampMillis?: InputMaybe<Scalars['String']['input']>;
...
type AssetAssetObservationsArgs = {
  afterTimestampMillis?: InputMaybe<Scalars['String']['input']>;
  beforeTimestampMillis?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  partitions?: InputMaybe<Array<Scalars['String']['input']>>;
...
type AssetBackfillPreviewParams = {
  assetSelection: Array<AssetKeyInput>;
  partitionNames: Array<Scalars['String']['input']>;
};

type AssetBackfillStatus = AssetPartitionsStatusCounts | UnpartitionedAssetStatus;
...
type AssetCheckPartitionKeysByDimensionArgs = {
...
type AssetCheckEvaluationEvent = MessageEvent &
  StepEvent & {
...
type AssetCheckEvaluationPlannedEvent = MessageEvent &
  StepEvent & {
...
type AssetCheckNeedsAgentUpgradeError = Error & {
  __typename: 'AssetCheckNeedsAgentUpgradeError';
  message: Scalars['String']['output'];
};

type AssetCheckNeedsMigrationError = Error & {
  __typename: 'AssetCheckNeedsMigrationError';
  message: Scalars['String']['output'];
};

type AssetCheckNeedsUserCodeUpgrade = Error & {
  __typename: 'AssetCheckNeedsUserCodeUpgrade';
  message: Scalars['String']['output'];
};

type AssetCheckNotFoundError = Error & {
  __typename: 'AssetCheckNotFoundError';
  message: Scalars['String']['output'];
};

type AssetCheckOrError =
  | AssetCheck
...
type AssetConditionEvaluationRecordsOrError =
...
type AssetMaterializationPlannedEvent = MessageEvent &
  RunEvent & {
...
type AssetMetadataEntry = MetadataEntry & {
...
type AssetNodeAssetCheckOrErrorArgs = {
  checkName: Scalars['String']['input'];
};

type AssetNodeAssetChecksOrErrorArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  pipeline?: InputMaybe<PipelineSelector>;
};

type AssetNodeAssetMaterializationUsedDataArgs = {
  timestampMillis: Scalars['String']['input'];
};

type AssetNodeAssetMaterializationsArgs = {
  beforeTimestampMillis?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  partitions?: InputMaybe<Array<Scalars['String']['input']>>;
};

type AssetNodeAssetObservationsArgs = {
  beforeTimestampMillis?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  partitions?: InputMaybe<Array<Scalars['String']['input']>>;
};

type AssetNodeDataVersionArgs = {
...
type AssetNodeLatestMaterializationByPartitionArgs = {
  partitions?: InputMaybe<Array<Scalars['String']['input']>>;
};

type AssetNodeLatestRunForPartitionArgs = {
  partition: Scalars['String']['input'];
};

type AssetNodePartitionKeyConnectionArgs = {
  ascending: Scalars['Boolean']['input'];
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit: Scalars['Int']['input'];
};

type AssetNodePartitionKeysByDimensionArgs = {
  endIdx?: InputMaybe<Scalars['Int']['input']>;
  startIdx?: InputMaybe<Scalars['Int']['input']>;
};

type AssetNodeStaleCausesArgs = {
  partition?: InputMaybe<Scalars['String']['input']>;
};

type AssetNodeStaleCausesByPartitionArgs = {
  partitions?: InputMaybe<Array<Scalars['String']['input']>>;
};

type AssetNodeStaleStatusArgs = {
  partition?: InputMaybe<Scalars['String']['input']>;
};
...
type AssetNodeOrError = AssetNode | AssetNotFoundError;

type AssetNotFoundError = Error & {
  __typename: 'AssetNotFoundError';
  message: Scalars['String']['output'];
};

type AssetOrError = Asset | AssetNotFoundError;

type AssetOwner = TeamAssetOwner | UserAssetOwner;
...
type AssetRecordsOrError = AssetRecordConnection | PythonError;
...
type AssetResultEventType = FailedToMaterializeEvent | MaterializationEvent | ObservationEvent;
...
type AssetsOrError = AssetConnection | PythonError;

type AutoMaterializeAssetEvaluationNeedsMigrationError = Error & {
...
type AutoMaterializeAssetEvaluationRecordsOrError =
  | AutoMaterializeAssetEvaluationNeedsMigrationError
...
type AutoMaterializeRuleEvaluationData =
...
type BackfillNotFoundError = Error & {
...
type BoolMetadataEntry = MetadataEntry & {
...
type CancelBackfillResult = CancelBackfillSuccess | PythonError | UnauthorizedError;
...
type CodeReferencesMetadataEntry = MetadataEntry & {
...
type CompositeSolidDefinition = ISolidDefinition &
  SolidContainer & {
...
type CompositeSolidDefinitionSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type CompositeSolidDefinitionSolidHandlesArgs = {
...
type ConfigTypeNotFoundError = Error & {
...
type ConflictingExecutionParamsError = Error & {
...
type DaemonHealthDaemonStatusArgs = {
...
type DefinitionOwner = TeamDefinitionOwner | UserDefinitionOwner;
...
type DuplicateDynamicPartitionError = Error & {
...
type EngineEvent = DisplayableEvent &
  ErrorEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type EnvVarWithConsumersOrError = EnvVarWithConsumersList | PythonError;

type Error = {
  message: Scalars['String']['output'];
};

type ErrorChainLink = Error & {
...
type EventConnectionOrError = EventConnection | PythonError | RunNotFoundError;
...
type ExecutionStepFailureEvent = ErrorEvent &
  MessageEvent &
  StepEvent & {
...
type ExecutionStepInputEvent = MessageEvent &
  StepEvent & {
...
type ExecutionStepOutputEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type ExecutionStepRestartEvent = MessageEvent &
  StepEvent & {
...
type ExecutionStepSkippedEvent = MessageEvent &
  StepEvent & {
...
type ExecutionStepStartEvent = MessageEvent &
  StepEvent & {
...
type ExecutionStepSuccessEvent = MessageEvent &
  StepEvent & {
...
type ExecutionStepUpForRetryEvent = ErrorEvent &
  MessageEvent &
  StepEvent & {
...
type ExpectationResult = DisplayableEvent & {
...
type FailedToMaterializeEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type FailureMetadata = DisplayableEvent & {
...
type FieldNotDefinedConfigError = PipelineConfigValidationError & {
...
type FieldsNotDefinedConfigError = PipelineConfigValidationError & {
...
type FloatMetadataEntry = MetadataEntry & {
...
type GraphSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type GraphSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};

type GraphNotFoundError = Error & {
...
type GraphOrError = Graph | GraphNotFoundError | PythonError;
...
type HandledOutputEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type HealthChangedEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type HookCompletedEvent = MessageEvent &
  StepEvent & {
...
type HookErroredEvent = ErrorEvent &
  MessageEvent &
  StepEvent & {
...
type HookSkippedEvent = MessageEvent &
  StepEvent & {
...
type IPipelineSnapshotDagsterTypeOrErrorArgs = {
  dagsterTypeName: Scalars['String']['input'];
};

type IPipelineSnapshotRunsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type IPipelineSnapshotSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type IPipelineSnapshotSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};

type ISolidDefinition = {
  assetNodes: Array<AssetNode>;
  description: Maybe<Scalars['String']['output']>;
  inputDefinitions: Array<InputDefinition>;
  metadata: Array<MetadataItemDefinition>;
...
type InstanceConcurrencyLimitArgs = {
...
type InstigationStateRunsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type InstigationStateTickArgs = {
  tickId: Scalars['ID']['input'];
};

type InstigationStateTicksArgs = {
...
type InstigationStateNotFoundError = Error & {
  __typename: 'InstigationStateNotFoundError';
  message: Scalars['String']['output'];
  name: Scalars['String']['output'];
};

type InstigationStateOrError = InstigationState | InstigationStateNotFoundError | PythonError;
...
type InstigationStatesOrError = InstigationStates | PythonError;
...
type InstigationTypeSpecificData = ScheduleData | SensorData;

type Instigator = Schedule | Sensor;

type IntMetadataEntry = MetadataEntry & {
...
type InternalFreshnessPolicy = CronFreshnessPolicy | TimeWindowFreshnessPolicy;
...
type InvalidPipelineRunsFilterError = Error & {
...
type JobDagsterTypeOrErrorArgs = {
  dagsterTypeName: Scalars['String']['input'];
};

type JobPartitionArgs = {
  partitionName: Scalars['String']['input'];
  selectedAssetKeys?: InputMaybe<Array<AssetKeyInput>>;
};

type JobPartitionKeysOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
...
type JobSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type JobSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};

type JobMetadataEntry = MetadataEntry & {
...
type JsonMetadataEntry = MetadataEntry & {
...
type LaunchMultipleRunsResultOrError = LaunchMultipleRunsResult | PythonError;
...
type LaunchRunReexecutionResult =
  | ConflictingExecutionParamsError
  | InvalidOutputError
  | InvalidStepError
  | InvalidSubsetError
...
type LaunchRunSuccess = LaunchPipelineRunSuccess & {
  __typename: 'LaunchRunSuccess';
  run: Run;
};

type ListDagsterType = DagsterType &
  WrappingDagsterType & {
...
type LoadedInputEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type LogTelemetryMutationResult = LogTelemetrySuccess | PythonError;
...
type LogsCapturedEvent = MessageEvent & {
...
type MarkdownMetadataEntry = MetadataEntry & {
...
type MaterializationEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type MissingFieldConfigError = PipelineConfigValidationError & {
...
type MissingFieldsConfigError = PipelineConfigValidationError & {
...
type MutationAddDynamicPartitionArgs = {
...
type MutationDeleteDynamicPartitionsArgs = {
...
type MutationFreeConcurrencySlotsForRunArgs = {
  runId: Scalars['String']['input'];
};

type MutationLaunchMultipleRunsArgs = {
  executionParamsList: Array<ExecutionParams>;
};

type MutationLaunchPartitionBackfillArgs = {
  backfillParams: LaunchBackfillParams;
};

type MutationLaunchPipelineExecutionArgs = {
  executionParams: ExecutionParams;
};

type MutationLaunchPipelineReexecutionArgs = {
  executionParams?: InputMaybe<ExecutionParams>;
  reexecutionParams?: InputMaybe<ReexecutionParams>;
};

type MutationLaunchRunArgs = {
  executionParams: ExecutionParams;
};

type MutationLaunchRunReexecutionArgs = {
  executionParams?: InputMaybe<ExecutionParams>;
  reexecutionParams?: InputMaybe<ReexecutionParams>;
};

type MutationLogTelemetryArgs = {
...
type MutationResetSensorArgs = {
  sensorSelector: SensorSelector;
};

type MutationResumePartitionBackfillArgs = {
  backfillId: Scalars['String']['input'];
};

type MutationScheduleDryRunArgs = {
...
type MutationSetConcurrencyLimitArgs = {
  concurrencyKey: Scalars['String']['input'];
  limit: Scalars['Int']['input'];
};
...
type NoModeProvidedError = Error & {
...
type NotebookMetadataEntry = MetadataEntry & {
...
type NullMetadataEntry = MetadataEntry & {
  __typename: 'NullMetadataEntry';
  description: Maybe<Scalars['String']['output']>;
  label: Scalars['String']['output'];
};

type NullableConfigType = ConfigType &
  WrappingConfigType & {
...
type NullableDagsterType = DagsterType &
  WrappingDagsterType & {
...
type ObjectStoreOperationEvent = MessageEvent &
  StepEvent & {
...
type ObjectStoreOperationResult = DisplayableEvent & {
...
type ObservationEvent = DisplayableEvent &
  MessageEvent &
  StepEvent & {
...
type PartitionRunsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<RunsFilter>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PartitionBackfill = RunsFeedEntry & {
...
type PartitionBackfillCancelableRunsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PartitionBackfillLogEventsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
};

type PartitionBackfillPartitionsTargetedForAssetKeyArgs = {
  assetKey?: InputMaybe<AssetKeyInput>;
};

type PartitionBackfillRunsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PartitionBackfillUnfinishedRunsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PartitionBackfillOrError = BackfillNotFoundError | PartitionBackfill | PythonError;
...
type PartitionBackfillsOrError = PartitionBackfills | PythonError;
...
type PartitionKeysNotFoundError = Error & {
  __typename: 'PartitionKeysNotFoundError';
  message: Scalars['String']['output'];
  partitionKeys: Array<Scalars['String']['output']>;
};

type PartitionKeysOrError = PartitionKeys | PartitionSubsetDeserializationError;
...
type PartitionRunConfigOrError = PartitionRunConfig | PythonError;
...
type PartitionSetBackfillsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PartitionSetPartitionArgs = {
  partitionName: Scalars['String']['input'];
};

type PartitionSetPartitionsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  reverse?: InputMaybe<Scalars['Boolean']['input']>;
};

type PartitionSetNotFoundError = Error & {
  __typename: 'PartitionSetNotFoundError';
  message: Scalars['String']['output'];
  partitionSetName: Scalars['String']['output'];
};

type PartitionSetOrError = PartitionSet | PartitionSetNotFoundError | PythonError;

type PartitionSetSelector = {
...
type PartitionSetsOrError = PartitionSets | PipelineNotFoundError | PythonError;
...
type PartitionStatus1D = DefaultPartitionStatuses | TimePartitionStatuses;
...
type PartitionStatusesOrError = PartitionStatuses | PythonError;

type PartitionSubsetDeserializationError = Error & {
...
type PartitionTagsOrError = PartitionTags | PythonError;
...
type PartitionsByAssetSelector = {
  assetKey: AssetKeyInput;
  partitions?: InputMaybe<PartitionsSelector>;
};

type PartitionsOrError = Partitions | PythonError;

type PartitionsSelector = {
  range?: InputMaybe<PartitionRangeSelector>;
  ranges?: InputMaybe<Array<PartitionRangeSelector>>;
};

type PathMetadataEntry = MetadataEntry & {
...
type PipelineDagsterTypeOrErrorArgs = {
  dagsterTypeName: Scalars['String']['input'];
};

type PipelinePartitionArgs = {
  partitionName: Scalars['String']['input'];
  selectedAssetKeys?: InputMaybe<Array<AssetKeyInput>>;
};

type PipelinePartitionKeysOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  reverse?: InputMaybe<Scalars['Boolean']['input']>;
  selectedAssetKeys?: InputMaybe<Array<AssetKeyInput>>;
...
type PipelineRunsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PipelineSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type PipelineSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};
...
type PipelineConfigValidationResult =
  | InvalidSubsetError
...
type PipelineNotFoundError = Error & {
...
type PipelineOrError = InvalidSubsetError | Pipeline | PipelineNotFoundError | PythonError;
...
type PipelineRunCapturedLogsArgs = {
  fileKey: Scalars['String']['input'];
};

type PipelineRunEventConnectionArgs = {
  afterCursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PipelineRunConflict = {
  message: Scalars['String']['output'];
};
...
type PipelineRunMetadataEntry = MetadataEntry & {
...
type PipelineSnapshot = IPipelineSnapshot &
  PipelineReference &
  SolidContainer & {
...
type PipelineSnapshotDagsterTypeOrErrorArgs = {
  dagsterTypeName: Scalars['String']['input'];
};

type PipelineSnapshotRunsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type PipelineSnapshotSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type PipelineSnapshotSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};

type PipelineSnapshotNotFoundError = Error & {
  __typename: 'PipelineSnapshotNotFoundError';
  message: Scalars['String']['output'];
  snapshotId: Scalars['String']['output'];
};

type PipelineSnapshotOrError =
  | PipelineNotFoundError
  | PipelineSnapshot
...
type PoolMetadataEntry = MetadataEntry & {
...
type PresetNotFoundError = Error & {
  __typename: 'PresetNotFoundError';
  message: Scalars['String']['output'];
  preset: Scalars['String']['output'];
};

type PythonArtifactMetadataEntry = MetadataEntry & {
...
type QueryAssetCheckExecutionsArgs = {
  assetKey: AssetKeyInput;
  checkName: Scalars['String']['input'];
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit: Scalars['Int']['input'];
...
type QueryAssetConditionEvaluationForPartitionArgs = {
  assetKey?: InputMaybe<AssetKeyInput>;
...
type QueryAssetConditionEvaluationsForEvaluationIdArgs = {
  evaluationId: Scalars['ID']['input'];
};

type QueryAssetNodeAdditionalRequiredKeysArgs = {
  assetKeys: Array<AssetKeyInput>;
};

type QueryAssetNodeDefinitionCollisionsArgs = {
  assetKeys: Array<AssetKeyInput>;
};

type QueryAssetNodeOrErrorArgs = {
  assetKey: AssetKeyInput;
};

type QueryAssetNodesArgs = {
...
type QueryAssetOrErrorArgs = {
  assetKey: AssetKeyInput;
};

type QueryAssetRecordsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  prefix?: InputMaybe<Array<Scalars['String']['input']>>;
};

type QueryAssetsLatestInfoArgs = {
  assetKeys: Array<AssetKeyInput>;
};

type QueryAssetsOrErrorArgs = {
  assetKeys?: InputMaybe<Array<AssetKeyInput>>;
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  prefix?: InputMaybe<Array<Scalars['String']['input']>>;
...
type QueryAutoMaterializeAssetEvaluationsOrErrorArgs = {
  assetKey: AssetKeyInput;
  cursor?: InputMaybe<Scalars['String']['input']>;
  limit: Scalars['Int']['input'];
};

type QueryAutoMaterializeEvaluationsForEvaluationIdArgs = {
  evaluationId: Scalars['ID']['input'];
};

type QueryAutoMaterializeTicksArgs = {
  afterTimestamp?: InputMaybe<Scalars['Float']['input']>;
  beforeTimestamp?: InputMaybe<Scalars['Float']['input']>;
  cursor?: InputMaybe<Scalars['String']['input']>;
  dayOffset?: InputMaybe<Scalars['Int']['input']>;
...
type QueryGraphOrErrorArgs = {
  selector?: InputMaybe<GraphSelector>;
};

type QueryInstigationStateOrErrorArgs = {
  id?: InputMaybe<Scalars['String']['input']>;
  instigationSelector: InstigationSelector;
};

type QueryInstigationStatesOrErrorArgs = {
  repositoryID: Scalars['String']['input'];
};

type QueryIsPipelineConfigValidArgs = {
  mode: Scalars['String']['input'];
  pipeline: PipelineSelector;
  runConfigData?: InputMaybe<Scalars['RunConfigData']['input']>;
};

type QueryLogsForRunArgs = {
  afterCursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  runId: Scalars['ID']['input'];
};

type QueryPartitionBackfillOrErrorArgs = {
  backfillId: Scalars['String']['input'];
};

type QueryPartitionBackfillsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
...
type QueryPartitionSetOrErrorArgs = {
  partitionSetName?: InputMaybe<Scalars['String']['input']>;
  repositorySelector: RepositorySelector;
};

type QueryPartitionSetsOrErrorArgs = {
  pipelineName: Scalars['String']['input'];
  repositorySelector: RepositorySelector;
};

type QueryPipelineOrErrorArgs = {
  params: PipelineSelector;
};

type QueryPipelineRunOrErrorArgs = {
  runId: Scalars['ID']['input'];
};

type QueryPipelineRunsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<RunsFilter>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type QueryPipelineSnapshotOrErrorArgs = {
  activePipelineSelector?: InputMaybe<PipelineSelector>;
  snapshotId?: InputMaybe<Scalars['String']['input']>;
};

type QueryRepositoriesOrErrorArgs = {
  repositorySelector?: InputMaybe<RepositorySelector>;
};

type QueryRepositoryOrErrorArgs = {
  repositorySelector: RepositorySelector;
};

type QueryResourcesOrErrorArgs = {
  pipelineSelector: PipelineSelector;
};

type QueryRunConfigSchemaOrErrorArgs = {
  mode?: InputMaybe<Scalars['String']['input']>;
  selector: PipelineSelector;
};

type QueryRunGroupOrErrorArgs = {
  runId: Scalars['ID']['input'];
};

type QueryRunIdsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<RunsFilter>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type QueryRunOrErrorArgs = {
  runId: Scalars['ID']['input'];
};

type QueryRunTagsOrErrorArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  tagKeys?: InputMaybe<Array<Scalars['String']['input']>>;
  valuePrefix?: InputMaybe<Scalars['String']['input']>;
};

type QueryRunsFeedCountOrErrorArgs = {
  filter?: InputMaybe<RunsFilter>;
  view: RunsFeedView;
};

type QueryRunsFeedOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<RunsFilter>;
  limit: Scalars['Int']['input'];
  view: RunsFeedView;
...
type QueryRunsOrErrorArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<RunsFilter>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type QueryScheduleOrErrorArgs = {
  scheduleSelector: ScheduleSelector;
};

type QuerySchedulesOrErrorArgs = {
  repositorySelector: RepositorySelector;
  scheduleStatus?: InputMaybe<InstigationStatus>;
};

type QuerySensorOrErrorArgs = {
  sensorSelector: SensorSelector;
};

type QuerySensorsOrErrorArgs = {
  repositorySelector: RepositorySelector;
  sensorStatus?: InputMaybe<InstigationStatus>;
};

type QueryTopLevelResourceDetailsOrErrorArgs = {
...
type QueryWorkspaceLocationEntryOrErrorArgs = {
  name: Scalars['String']['input'];
};

type ReexecutionParams = {
...
type RegularDagsterType = DagsterType & {
...
type ReloadRepositoryLocationMutationResult =
  | PythonError
  | ReloadNotSupported
...
type ReportRunlessAssetEventsResult =
  | PythonError
...
type RepositoryLocationNotFound = Error & {
  __typename: 'RepositoryLocationNotFound';
  message: Scalars['String']['output'];
};

type RepositoryLocationOrLoadError = PythonError | RepositoryLocation;
...
type RepositoryNotFoundError = Error & {
...
type RepositoryOrError = PythonError | Repository | RepositoryNotFoundError;
...
type ResourceDetailsListOrError = PythonError | RepositoryNotFoundError | ResourceDetailsList;

type ResourceDetailsOrError = PythonError | ResourceDetails | ResourceNotFoundError;

type ResourceInitFailureEvent = DisplayableEvent &
  ErrorEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type ResourceInitStartedEvent = DisplayableEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type ResourceInitSuccessEvent = DisplayableEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type ResourcesOrError =
  | InvalidSubsetError
  | PipelineNotFoundError
  | PythonError
  | ResourceConnection;

type ResumeBackfillResult = PythonError | ResumeBackfillSuccess | UnauthorizedError;
...
type RunEventConnectionArgs = {
  afterCursor?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};

type RunCanceledEvent = ErrorEvent &
  MessageEvent &
  RunEvent & {
...
type RunCancelingEvent = MessageEvent &
  RunEvent & {
...
type RunConfigSchemaIsRunConfigValidArgs = {
  runConfigData?: InputMaybe<Scalars['RunConfigData']['input']>;
};

type RunConfigSchemaOrError =
  | InvalidSubsetError
  | ModeNotFoundError
  | PipelineNotFoundError
  | PythonError
...
type RunConfigValidationInvalid = PipelineConfigValidationInvalid & {
...
type RunConflict = Error &
  PipelineRunConflict & {
    __typename: 'RunConflict';
    message: Scalars['String']['output'];
  };

type RunDequeuedEvent = MessageEvent &
  RunEvent & {
...
type RunEnqueuedEvent = MessageEvent &
  RunEvent & {
...
type RunFailureEvent = ErrorEvent &
  MessageEvent &
  RunEvent & {
...
type RunGroupNotFoundError = Error & {
  __typename: 'RunGroupNotFoundError';
  message: Scalars['String']['output'];
  runId: Scalars['String']['output'];
};

type RunGroupOrError = PythonError | RunGroup | RunGroupNotFoundError;
...
type RunIdsOrError = InvalidPipelineRunsFilterError | PythonError | RunIds;
...
type RunOrError = PythonError | Run | RunNotFoundError;
...
type RunStartingEvent = MessageEvent &
  RunEvent & {
...
type RunStatsSnapshot = PipelineRunStatsSnapshot & {
...
type RunStatsSnapshotOrError = PythonError | RunStatsSnapshot;

export {RunStatus};

type RunStepStats = PipelineRunStepStats & {
...
type RunTagKeysOrError = PythonError | RunTagKeys;
...
type RunTagsOrError = PythonError | RunTags;
...
type RunsFeedConnectionOrError = PythonError | RunsFeedConnection;
...
type RunsFeedCountOrError = PythonError | RunsFeedCount;
...
type RunsOrError = InvalidPipelineRunsFilterError | PythonError | Runs;

type RuntimeMismatchConfigError = PipelineConfigValidationError & {
...
type ScalarUnionConfigType = ConfigType & {
...
type ScheduleNotFoundError = Error & {
  __typename: 'ScheduleNotFoundError';
  message: Scalars['String']['output'];
  scheduleName: Scalars['String']['output'];
};

type ScheduleOrError = PythonError | Schedule | ScheduleNotFoundError;
...
type ScheduleTickSpecificData = ScheduleTickFailureData | ScheduleTickSuccessData;
...
type SchedulerNotDefinedError = Error & {
  __typename: 'SchedulerNotDefinedError';
  message: Scalars['String']['output'];
};

type SchedulerOrError = PythonError | Scheduler | SchedulerNotDefinedError;
...
type SchedulesOrError = PythonError | RepositoryNotFoundError | Schedules;

type SelectorTypeConfigError = PipelineConfigValidationError & {
...
type SensorNotFoundError = Error & {
  __typename: 'SensorNotFoundError';
  message: Scalars['String']['output'];
  sensorName: Scalars['String']['output'];
};

type SensorOrError = PythonError | Sensor | SensorNotFoundError | UnauthorizedError;
...
type ShutdownRepositoryLocationMutationResult =
  | PythonError
  | RepositoryLocationNotFound
...
type SolidContainerSolidHandleArgs = {
  handleID: Scalars['String']['input'];
};

type SolidContainerSolidHandlesArgs = {
  parentHandleID?: InputMaybe<Scalars['String']['input']>;
};

type SolidDefinition = ISolidDefinition & {
...
type SolidStepStatsOrError = SolidStepStatsConnection | SolidStepStatusUnavailableError;

type SolidStepStatusUnavailableError = Error & {
  __typename: 'SolidStepStatusUnavailableError';
  message: Scalars['String']['output'];
};

type SourceLocation = LocalFileCodeReference | UrlCodeReference;
...
type StepExpectationResultEvent = MessageEvent &
  StepEvent & {
...
type StepOutputHandle = {
  outputName: Scalars['String']['input'];
  stepKey: Scalars['String']['input'];
};

type StepWorkerStartedEvent = DisplayableEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type StepWorkerStartingEvent = DisplayableEvent &
  MarkerEvent &
  MessageEvent &
  StepEvent & {
...
type SubscriptionCapturedLogsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  logKey: Array<Scalars['String']['input']>;
};

type SubscriptionPipelineRunLogsArgs = {
  cursor?: InputMaybe<Scalars['String']['input']>;
  runId: Scalars['ID']['input'];
};
...
type TableColumnLineageMetadataEntry = MetadataEntry & {
...
type TableMetadataEntry = MetadataEntry & {
...
type TableSchemaMetadataEntry = MetadataEntry & {
...
type TerminateRunFailure = TerminatePipelineExecutionFailure & {
...
type TerminateRunSuccess = TerminatePipelineExecutionSuccess & {
...
type TerminateRunsResultOrError = PythonError | TerminateRunsResult;
...
type TextMetadataEntry = MetadataEntry & {
...
type TimestampMetadataEntry = MetadataEntry & {
...
type TypeCheck = DisplayableEvent & {
...
type UnknownPipeline = PipelineReference & {
...
type UrlMetadataEntry = MetadataEntry & {
...
type WorkspaceLocationEntryOrError = PythonError | WorkspaceLocationEntry;
...
type WorkspaceLocationStatusEntriesOrError = PythonError | WorkspaceLocationStatusEntries;
...
type WorkspaceOrError = PythonError | Workspace;

type WrappingConfigType = {
  ofType:
    | ArrayConfigType
    | CompositeConfigType
    | EnumConfigType
...
export const buildAssetNode = (
  ...
  return {
    ...
    isView: overrides && overrides.hasOwnProperty('isView') ? overrides.isView! : true,
    jobNames: overrides && overrides.hasOwnProperty('jobNames') ? overrides.jobNames! : [],
