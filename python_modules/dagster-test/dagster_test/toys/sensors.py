...
def get_directory_files(directory_name, since=None):
    ...
    try:
        since = float(since)  # pyright: ignore[reportArgumentType]  # ty: ignore[invalid-argument-type]
...
def get_toys_sensors():
    ...
    built_in_slack_on_run_failure_sensor = make_slack_on_run_failure_sensor(
        ...
        channel="#toy-test",
        slack_token=os.environ.get("SLACK_DAGSTER_ETL_BOT_TOKEN"),  # pyright: ignore[reportArgumentType]  # ty: ignore[invalid-argument-type]
