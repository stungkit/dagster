...
def upstream_daily_partitioned_asset_sensor(context):
    latest_partition = upstream_daily_partitioned_asset.partitions_def.get_partition_keys()[-1]  # pyright: ignore[reportOptionalMemberAccess]  # ty: ignore[unresolved-attribute]
