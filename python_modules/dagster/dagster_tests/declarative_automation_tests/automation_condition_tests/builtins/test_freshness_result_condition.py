...
class TestFreshnessResultCondition:
    ...
    def setup_method(self):
        ...
        self.__state_cache = {}
        yield
        self.instance = None  # ty: ignore[invalid-assignment]  # pyright: ignore[reportAttributeAccessIssue]
        self.__state_cache = {}
    ...
    def test_freshness_result_condition_invalid_state_param(self) -> None:
        with pytest.raises(ParameterCheckError):
            ...
            FreshnessResultCondition(state="Fresh")  # ty: ignore[invalid-argument-type]  # pyright: ignore[reportArgumentType]
