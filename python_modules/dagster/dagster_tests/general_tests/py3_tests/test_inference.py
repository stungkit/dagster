...
def test_wrapped_input_and_output_lambda():
    ...
    assert add_one.input_defs[0].dagster_type.inner_type.unique_name == "Int"  # pyright: ignore[reportAttributeAccessIssue]  # ty: ignore[unresolved-attribute]

    assert len(add_one.output_defs) == 1
    assert add_one.output_defs[0].dagster_type.kind == DagsterTypeKind.NULLABLE
    assert add_one.output_defs[0].dagster_type.inner_type.kind == DagsterTypeKind.LIST  # pyright: ignore[reportAttributeAccessIssue]  # ty: ignore[unresolved-attribute]
...
def test_infer_input_description_from_docstring_rest():
    ...
    defs = infer_input_props(rest.compute_fn.decorated_fn, context_arg_provided=True)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
    assert len(defs) == 2
...
def test_infer_descriptions_from_docstring_numpy():
    ...
    defs = infer_input_props(good_numpy.compute_fn.decorated_fn, context_arg_provided=True)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
    assert len(defs) == 2
...
def test_infer_descriptions_from_docstring_google():
    ...
    defs = infer_input_props(good_google.compute_fn.decorated_fn, context_arg_provided=True)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
    assert len(defs) == 2
...
def test_infer_output_description_from_docstring_numpy():
    ...
    props = infer_output_props(numpy.compute_fn.decorated_fn)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
...
def test_infer_output_description_from_docstring_rest():
    ...
    props = infer_output_props(rest.compute_fn.decorated_fn)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
    assert props.description == "a number."
    assert props.annotation == int
...
def test_infer_output_description_from_docstring_google():
    ...
    props = infer_output_props(google.compute_fn.decorated_fn)  # pyright: ignore[reportFunctionMemberAccess]  # ty: ignore[unresolved-attribute]
