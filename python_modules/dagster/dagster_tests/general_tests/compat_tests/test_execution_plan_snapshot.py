    ...
    for snapshot_dir_path in snapshot_dirs:
        ...
        with copy_directory(os.path.join(src_dir, snapshot_dir_path)) as test_dir:
            with DagsterInstance.from_ref(InstanceRef.from_dir(test_dir)) as instance:
                ...
                new_plan_snapshot = snapshot_from_execution_plan(new_plan, run.job_snapshot_id)  # pyright: ignore[reportArgumentType]  # ty: ignore[invalid-argument-type]
                ...
                stored_snapshot = instance.get_execution_plan_snapshot(
                    run.execution_plan_snapshot_id  # pyright: ignore[reportArgumentType]  # ty: ignore[invalid-argument-type]
                )
