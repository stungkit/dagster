...
class RunLauncherMethods:
    ...
    def submit_run(self, run_id: str, workspace: "BaseWorkspaceRequestContext") -> "DagsterRun":
        ...
        try:
            ...
            self.report_engine_event(  # pyright: ignore[reportAttributeAccessIssue]  # ty: ignore[unresolved-attribute]
                error.message,
                run,
                EngineEventData.engine_error(error),
            )
            self.report_run_failed(run)  # pyright: ignore[reportAttributeAccessIssue]  # ty: ignore[unresolved-attribute]
            raise
    ...
    def launch_run(self, run_id: str, workspace: "BaseWorkspaceRequestContext") -> "DagsterRun":
        ...
        self.report_dagster_event(launch_started_event, run_id=run.run_id)  # pyright: ignore[reportAttributeAccessIssue]  # ty: ignore[unresolved-attribute]
