        ...
        if previous_line is None:
            ...
            if match:
                ...
                if rule and "pyright:" not in rule:
                    file_path = error_pattern.match(previous_line).group("file_name")  # ty: ignore[unresolved-attribute]
                    line_number = int(error_pattern.match(previous_line).group("line_number"))  # ty: ignore[unresolved-attribute]
                    errors[file_path][line_number].append(rule)
